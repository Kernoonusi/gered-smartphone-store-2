...
return [
    ...
    */
    ...
    'ascii' => 'Поле :attribute может содержать только однобайтовые алфавитно-цифровые символы и знаки.',
    ...
    'digits_between' => 'Поле :attribute должно быть от :min до :max цифрами.',
    ...
    'min_digits' => 'Поле :attribute должно иметь как минимум :min цифр.',
